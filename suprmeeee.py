...
def SniperScopeon():
    ...
    if value:
        ...
        print("Sniper Scope Activated Successfully!")
...
def SniperScopeoff():
    ...
    try:
        if proc:
            print("Deactivating Sniper Scope", '\n' "Scanning...")
    ...
    if value:
        ...
        print("Sniper Scope Deactivated Successfully!")
...
def SniperSwitchon():
    ...
    if value:
        ...
        print("Sniper Switch Activated Successfully!")
...
def SniperSwitchoff():
    ...
    try:
        if proc:
            print("Deactivating Sniper Switch", '\n' "Scanning...")
    ...
    if value:
        ...
        print("Sniper Switch Deactivated Successfully!")
...
def SniperSwitchfixOn():
    ...
    try:
        if proc:
            print("Activating Sniper Switch Fix", '\n' "Scanning...")
    ...
    if value:
        ...
        print("Sniper Switch Fix Activated Successfully!")
...
def SniperSwitchfixOff():
    ...
    try:
        if proc:
            print("Deactivating Sniper Switch Fix", '\n' "Scanning...")
    ...
    if value:
        ...
        print("Sniper Switch Fix Deactivated Successfully!")
